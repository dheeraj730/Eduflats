 ...
 * @ORM\Table(name="university", indexes={@ORM\Index(name="fk_university_plan1_idx", columns={"plan_id"})})
 */
class University
{
    /**
    ...
    {
        return array('id', 'tUniversityName', 'tSubdomainName', 'bAccountValidity', 'bBlacklisted', 'dCreatedAt', 'dUpdatedAt', 'plan_id');
    }
}