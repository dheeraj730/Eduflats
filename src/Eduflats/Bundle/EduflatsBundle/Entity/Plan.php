...
class Plan
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="University", mappedBy="plan")
     */
    ...
    {
        return array('id', 'currencyCodeId', 'nListingName', 'nAdminAccounts', 'bEmailSupport', 'bPhoneSupport', 'bMailouts', 'bSslSetup', 'dCreatedAt', 'dUpdatedAt');
    }
}