...
class WebsiteSetting
{
    ...
    {
        return array('id', 'timeZoneId', 'hexValueId', 'tWebsiteName', 'tTagLine', 'tInstitutionName', 'tEmailTrackingAddress', 'tEmail_reply-to', 'nCountry', 'bHTTPS', 'bGoogleAnalytics', 'bWebmasterTools', 'nWebsitelaguage', 'bMailchimp', 'tMailchimpAPIkey', 'dUpdatedAt', 'dCreatedAt', 'university_id');
    }
}